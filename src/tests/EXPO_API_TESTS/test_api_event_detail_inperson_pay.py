...
try:
    api = API()
    response_api = api.get_inperson_pay_event_detail_page()
...
def test_status_code_inperson_pay_event_detail_page():
    assert status_code_api == 200


def test_inperson_pay_title_is_not_empty():
    inperson_pay_title = response_api_json['pageProps']['event']['pageTitle']
    assert inperson_pay_title is not None and inperson_pay_title != ''


def test_inperson_pay_slug_is_not_empty():
    inperson_pay_slug = response_api_json['pageProps']['event']['slug']
    assert inperson_pay_slug is not None and inperson_pay_slug != ''


def test_inperson_pay_price_is_not_empty():
    inperson_pay_price = response_api_json['pageProps']['event']['pricingNumber']
    assert inperson_pay_price is not None and inperson_pay_price != ''


def test_inperson_pay_platinum_list_url_is_not_empty():
    inperson_pay_platinum_list_url = response_api_json['pageProps']['event']['platinumListUrl']
    assert inperson_pay_platinum_list_url is not None and inperson_pay_platinum_list_url != ''


def test_inperson_pay_event_type_is_not_empty():
    inperson_pay_event_type = response_api_json['pageProps']['event']['eventType']
    assert inperson_pay_event_type is not None and inperson_pay_event_type != '' and inperson_pay_event_type == 'In-Person'


def test_inperson_pay_event_opening_hours_is_not_empty():
    inperson_pay_event_opening_hours = response_api_json['pageProps']['event']['inPersonOpeningHoursNew']
    assert inperson_pay_event_opening_hours is not None and inperson_pay_event_opening_hours != ''


def test_inperson_pay_list_category_collection_is_not_empty():
...
def test_inperson_pay_speaker_group_is_not_empty():
